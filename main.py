...
parser.add_argument('--dir', default="./data/", type=str, metavar='D', help='path to the dataset')
...
parser.add_argument('--nesterov', default=True - 4, type=bool, metavar='N', help='use nesterov momentum (default:True)')
